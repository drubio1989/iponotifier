  ...
  return (
      <footer>
        <div className="bg-teal-500">
          ...
          <div className="py-5">
            <p className="text-center text-lg text-body-color dark:text-white font-bold font-mono">
              Disclaimer:
            </p>
            <p className="px-12 pb-5 text-center text-sm text-body-color dark:text-white font-bold font-mono">
